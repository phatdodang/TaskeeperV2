...
const Verifycation = (props) => {
    const {googleToken} = props.route.params;
    ...
    return (
        ...
        <View style={AppStyle.StyleVerifycation.container}>
            ...
            <View style={AppStyle.StyleVerifycation.footer}>
                <TouchableOpacity onPress={showmodal} style={AppStyle.StyleVerifycation.button}>
            ...
            >
                <View style={AppStyle.StyleVerifycation.containermodal} >
                    <View style={AppStyle.StyleVerifycation.formmodal}>
                        ...
                        <TouchableOpacity onPress={hideModal} style={AppStyle.StyleVerifycation.buttonmodal}>
